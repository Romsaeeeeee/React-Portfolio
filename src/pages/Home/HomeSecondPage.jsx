...
const HomeSecondPage = () => {
  return (
    <div className="h-full w-full flex flex-col gap-20 py-20 justify-start items-start ">
      <div className="flex flex-col justify-start items-start gap-5 px-40 tablet:w-full tablet:px-10 tablet:items-center">
        ...
        <p className="text-xl text-justify">
          I am an aspiring web developer with a passion for creating dynamic and
          responsive websites. I have a strong foundation in HTML5, CSS3,
